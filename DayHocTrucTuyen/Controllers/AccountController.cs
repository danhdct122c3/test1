...
namespace DayHocTrucTuyen.Controllers
{
    public class AccountController : Controller
    {
        ...
        {
            // Mật khẩu phải dài ít nhất 8 ký tự, có chữ hoa, chữ thường, số và ký tự đặc biệt
        ...
        public async Task<IActionResult> createAccount(string holot, string ten, string email, string matkhau)
        {
            ...
            if (!IsPasswordStrong(matkhau))
            {
                return Json(new { tt = false, erro = "password", mess = "Mật khẩu phải dài ít nhất 8 ký tự, bao gồm chữ hoa, chữ thường, số và ký tự đặc biệt." });
            }
